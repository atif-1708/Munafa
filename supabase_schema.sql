...
-- ==========================================
-- TABLES (Commented out to prevent errors if they exist)
-- Uncomment these if you are setting up a fresh database
-- ==========================================
...
-- ==========================================
-- RLS POLICIES (Run this section to fix permissions)
-- ==========================================
...
-- Products (CRITICAL FIX: Added WITH CHECK)
